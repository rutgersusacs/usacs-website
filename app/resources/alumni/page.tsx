...
// Reads content from a markdown file and displays it as a formatted article

export default async function AlumniPage() {
  // Path to the alumni markdown file
  ...
  return (
    <div className="max-w-[900px] mx-auto py-10 px-6">
      ...
      {/* Styles applied to markdown content (headings, lists, links, etc) */}
      <article
        className="
